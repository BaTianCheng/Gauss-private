/**
 * XI_0Dd06Aa25D70304Ba8A899814B24C3F2_ServiceLocator.java
 *
...
public class XI_0Dd06Aa25D70304Ba8A899814B24C3F2_ServiceLocator extends org.apache.axis.client.Service implements com.esb.jinying.sap.mastdata.rvs.ecc.XI_0Dd06Aa25D70304Ba8A899814B24C3F2_Service {

    public XI_0Dd06Aa25D70304Ba8A899814B24C3F2_ServiceLocator() {
    }


    public XI_0Dd06Aa25D70304Ba8A899814B24C3F2_ServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public XI_0Dd06Aa25D70304Ba8A899814B24C3F2_ServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for HTTP_Port
    private java.lang.String HTTP_Port_address = "http://srvgxp.goodee.cn:80/XISOAPAdapter/MessageServlet?senderParty=&senderService=BC_RVS&receiverParty=&receiverService=&interface=SI_Organization_os&interfaceNamespace=urn%3Aecc%3Arvs%3Amastdata";
    ...
    public com.esb.jinying.sap.mastdata.rvs.ecc.SI_Organization_os getHTTP_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.esb.jinying.sap.mastdata.rvs.ecc.SI_Organization_osBindingStub _stub = new com.esb.jinying.sap.mastdata.rvs.ecc.SI_Organization_osBindingStub(portAddress, this);
    ...
    private java.lang.String HTTPS_Port_address = "https://srvgxp.goodee.cn/XISOAPAdapter/MessageServlet?senderParty=&senderService=BC_RVS&receiverParty=&receiverService=&interface=SI_Organization_os&interfaceNamespace=urn%3Aecc%3Arvs%3Amastdata";
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.esb.jinying.sap.mastdata.rvs.ecc.SI_Organization_os.class.isAssignableFrom(serviceEndpointInterface)) {
                com.esb.jinying.sap.mastdata.rvs.ecc.SI_Organization_osBindingStub _stub = new com.esb.jinying.sap.mastdata.rvs.ecc.SI_Organization_osBindingStub(new java.net.URL(HTTP_Port_address), this);
                _stub.setPortName(getHTTP_PortWSDDServiceName());
                return _stub;
            }
            if (com.esb.jinying.sap.mastdata.rvs.ecc.SI_Organization_os.class.isAssignableFrom(serviceEndpointInterface)) {
                com.esb.jinying.sap.mastdata.rvs.ecc.SI_Organization_osBindingStub _stub = new com.esb.jinying.sap.mastdata.rvs.ecc.SI_Organization_osBindingStub(new java.net.URL(HTTPS_Port_address), this);
                _stub.setPortName(getHTTPS_PortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:ecc:rvs:mastdata", "XI_0dd06aa25d70304ba8a899814b24c3f2_Service");
    }
