/**
 * XI_b6126D9C98333D9F8Ad01010Ce6De9Dc_ServiceLocator.java
 *
...
public class XI_b6126D9C98333D9F8Ad01010Ce6De9Dc_ServiceLocator extends org.apache.axis.client.Service implements com.esb.jinying.sap.mastdata.rvs.ecc.XI_b6126D9C98333D9F8Ad01010Ce6De9Dc_Service {

    public XI_b6126D9C98333D9F8Ad01010Ce6De9Dc_ServiceLocator() {
    }


    public XI_b6126D9C98333D9F8Ad01010Ce6De9Dc_ServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public XI_b6126D9C98333D9F8Ad01010Ce6De9Dc_ServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for HTTP_Port
    private java.lang.String HTTP_Port_address = "http://srvgxp.goodee.cn:80/XISOAPAdapter/MessageServlet?senderParty=&senderService=BC_RVS&receiverParty=&receiverService=&interface=SI_BuildingData_os&interfaceNamespace=urn%3Aecc%3Arvs%3Amastdata";
    ...
    public com.esb.jinying.sap.mastdata.rvs.ecc.SI_BuildingData_os getHTTP_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.esb.jinying.sap.mastdata.rvs.ecc.SI_BuildingData_osBindingStub _stub = new com.esb.jinying.sap.mastdata.rvs.ecc.SI_BuildingData_osBindingStub(portAddress, this);
    ...
    private java.lang.String HTTPS_Port_address = "https://srvgxp.goodee.cn/XISOAPAdapter/MessageServlet?senderParty=&senderService=BC_RVS&receiverParty=&receiverService=&interface=SI_BuildingData_os&interfaceNamespace=urn%3Aecc%3Arvs%3Amastdata";
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.esb.jinying.sap.mastdata.rvs.ecc.SI_BuildingData_os.class.isAssignableFrom(serviceEndpointInterface)) {
                com.esb.jinying.sap.mastdata.rvs.ecc.SI_BuildingData_osBindingStub _stub = new com.esb.jinying.sap.mastdata.rvs.ecc.SI_BuildingData_osBindingStub(new java.net.URL(HTTP_Port_address), this);
                _stub.setPortName(getHTTP_PortWSDDServiceName());
                return _stub;
            }
            if (com.esb.jinying.sap.mastdata.rvs.ecc.SI_BuildingData_os.class.isAssignableFrom(serviceEndpointInterface)) {
                com.esb.jinying.sap.mastdata.rvs.ecc.SI_BuildingData_osBindingStub _stub = new com.esb.jinying.sap.mastdata.rvs.ecc.SI_BuildingData_osBindingStub(new java.net.URL(HTTPS_Port_address), this);
                _stub.setPortName(getHTTPS_PortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:ecc:rvs:mastdata", "XI_b6126d9c98333d9f8ad01010ce6de9dc_Service");
    }
