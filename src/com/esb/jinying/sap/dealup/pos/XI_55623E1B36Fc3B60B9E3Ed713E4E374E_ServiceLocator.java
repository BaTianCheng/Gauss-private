/**
 * XI_55623E1B36Fc3B60B9E3Ed713E4E374E_ServiceLocator.java
 *
...
public class XI_55623E1B36Fc3B60B9E3Ed713E4E374E_ServiceLocator extends org.apache.axis.client.Service implements com.esb.jinying.sap.dealup.pos.XI_55623E1B36Fc3B60B9E3Ed713E4E374E_Service {

    public XI_55623E1B36Fc3B60B9E3Ed713E4E374E_ServiceLocator() {
    }


    public XI_55623E1B36Fc3B60B9E3Ed713E4E374E_ServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public XI_55623E1B36Fc3B60B9E3Ed713E4E374E_ServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for HTTP_Port
    private java.lang.String HTTP_Port_address = "http://srvgxp.goodee.cn:80/XISOAPAdapter/MessageServlet?senderParty=&senderService=BS_POS&receiverParty=&receiverService=&interface=SIO_POS010&interfaceNamespace=urn%3Apos%3Adealup";
    ...
    public com.esb.jinying.sap.dealup.pos.SIO_POS010 getHTTP_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.esb.jinying.sap.dealup.pos.SIO_POS010BindingStub _stub = new com.esb.jinying.sap.dealup.pos.SIO_POS010BindingStub(portAddress, this);
    ...
    private java.lang.String HTTPS_Port_address = "https://srvgxp.goodee.cn/XISOAPAdapter/MessageServlet?senderParty=&senderService=BS_POS&receiverParty=&receiverService=&interface=SIO_POS010&interfaceNamespace=urn%3Apos%3Adealup";
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.esb.jinying.sap.dealup.pos.SIO_POS010.class.isAssignableFrom(serviceEndpointInterface)) {
                com.esb.jinying.sap.dealup.pos.SIO_POS010BindingStub _stub = new com.esb.jinying.sap.dealup.pos.SIO_POS010BindingStub(new java.net.URL(HTTP_Port_address), this);
                _stub.setPortName(getHTTP_PortWSDDServiceName());
                return _stub;
            }
            if (com.esb.jinying.sap.dealup.pos.SIO_POS010.class.isAssignableFrom(serviceEndpointInterface)) {
                com.esb.jinying.sap.dealup.pos.SIO_POS010BindingStub _stub = new com.esb.jinying.sap.dealup.pos.SIO_POS010BindingStub(new java.net.URL(HTTPS_Port_address), this);
                _stub.setPortName(getHTTPS_PortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:pos:dealup", "XI_55623e1b36fc3b60b9e3ed713e4e374e_Service");
    }
