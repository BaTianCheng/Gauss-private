/**
 * XI_28Cc3F266A343E528A403D647004Ee37_ServiceLocator.java
 *
...
public class XI_28Cc3F266A343E528A403D647004Ee37_ServiceLocator extends org.apache.axis.client.Service implements com.esb.jinying.sap.dealup.rf.XI_28Cc3F266A343E528A403D647004Ee37_Service {

    public XI_28Cc3F266A343E528A403D647004Ee37_ServiceLocator() {
    }


    public XI_28Cc3F266A343E528A403D647004Ee37_ServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public XI_28Cc3F266A343E528A403D647004Ee37_ServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for HTTP_Port
    private java.lang.String HTTP_Port_address = "http://SRVGXD01:50000/XISOAPAdapter/MessageServlet?senderParty=&senderService=BS_RF&receiverParty=&receiverService=&interface=SIO_RF&interfaceNamespace=urn%3Arf%3Adealup";
    ...
    public com.esb.jinying.sap.dealup.rf.SIO_RF getHTTP_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.esb.jinying.sap.dealup.rf.SIO_RFBindingStub _stub = new com.esb.jinying.sap.dealup.rf.SIO_RFBindingStub(portAddress, this);
    ...
    private java.lang.String HTTPS_Port_address = "https://SRVGXD01/XISOAPAdapter/MessageServlet?senderParty=&senderService=BS_RF&receiverParty=&receiverService=&interface=SIO_RF&interfaceNamespace=urn%3Arf%3Adealup";
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.esb.jinying.sap.dealup.rf.SIO_RF.class.isAssignableFrom(serviceEndpointInterface)) {
                com.esb.jinying.sap.dealup.rf.SIO_RFBindingStub _stub = new com.esb.jinying.sap.dealup.rf.SIO_RFBindingStub(new java.net.URL(HTTP_Port_address), this);
                _stub.setPortName(getHTTP_PortWSDDServiceName());
                return _stub;
            }
            if (com.esb.jinying.sap.dealup.rf.SIO_RF.class.isAssignableFrom(serviceEndpointInterface)) {
                com.esb.jinying.sap.dealup.rf.SIO_RFBindingStub _stub = new com.esb.jinying.sap.dealup.rf.SIO_RFBindingStub(new java.net.URL(HTTPS_Port_address), this);
                _stub.setPortName(getHTTPS_PortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:rf:dealup", "XI_28cc3f266a343e528a403d647004ee37_Service");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn:rf:dealup", "HTTP_Port"));
            ports.add(new javax.xml.namespace.QName("urn:rf:dealup", "HTTPS_Port"));
        }
