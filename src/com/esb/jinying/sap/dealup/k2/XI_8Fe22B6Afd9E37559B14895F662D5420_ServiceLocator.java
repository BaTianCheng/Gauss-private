/**
 * XI_8Fe22B6Afd9E37559B14895F662D5420_ServiceLocator.java
 *
...
public class XI_8Fe22B6Afd9E37559B14895F662D5420_ServiceLocator extends org.apache.axis.client.Service implements com.esb.jinying.sap.dealup.k2.XI_8Fe22B6Afd9E37559B14895F662D5420_Service {

    public XI_8Fe22B6Afd9E37559B14895F662D5420_ServiceLocator() {
    }


    public XI_8Fe22B6Afd9E37559B14895F662D5420_ServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public XI_8Fe22B6Afd9E37559B14895F662D5420_ServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for HTTP_Port
    private java.lang.String HTTP_Port_address = "http://SRVGXD01:50000/XISOAPAdapter/MessageServlet?senderParty=&senderService=BS_RF&receiverParty=&receiverService=&interface=SIO_K2&interfaceNamespace=urn%3Ak2%3Adealup";
    ...
    public com.esb.jinying.sap.dealup.k2.SIO_K2 getHTTP_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.esb.jinying.sap.dealup.k2.SIO_K2BindingStub _stub = new com.esb.jinying.sap.dealup.k2.SIO_K2BindingStub(portAddress, this);
    ...
    private java.lang.String HTTPS_Port_address = "https://SRVGXD01/XISOAPAdapter/MessageServlet?senderParty=&senderService=BS_RF&receiverParty=&receiverService=&interface=SIO_K2&interfaceNamespace=urn%3Ak2%3Adealup";
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.esb.jinying.sap.dealup.k2.SIO_K2.class.isAssignableFrom(serviceEndpointInterface)) {
                com.esb.jinying.sap.dealup.k2.SIO_K2BindingStub _stub = new com.esb.jinying.sap.dealup.k2.SIO_K2BindingStub(new java.net.URL(HTTP_Port_address), this);
                _stub.setPortName(getHTTP_PortWSDDServiceName());
                return _stub;
            }
            if (com.esb.jinying.sap.dealup.k2.SIO_K2.class.isAssignableFrom(serviceEndpointInterface)) {
                com.esb.jinying.sap.dealup.k2.SIO_K2BindingStub _stub = new com.esb.jinying.sap.dealup.k2.SIO_K2BindingStub(new java.net.URL(HTTPS_Port_address), this);
                _stub.setPortName(getHTTPS_PortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:k2:dealup", "XI_8fe22b6afd9e37559b14895f662d5420_Service");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn:k2:dealup", "HTTP_Port"));
            ports.add(new javax.xml.namespace.QName("urn:k2:dealup", "HTTPS_Port"));
        }
