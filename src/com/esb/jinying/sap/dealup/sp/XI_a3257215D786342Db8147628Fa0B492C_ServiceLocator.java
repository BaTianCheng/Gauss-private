/**
 * XI_a3257215D786342Db8147628Fa0B492C_ServiceLocator.java
 *
...
public class XI_a3257215D786342Db8147628Fa0B492C_ServiceLocator extends org.apache.axis.client.Service implements com.esb.jinying.sap.dealup.sp.XI_a3257215D786342Db8147628Fa0B492C_Service {

    public XI_a3257215D786342Db8147628Fa0B492C_ServiceLocator() {
    }


    public XI_a3257215D786342Db8147628Fa0B492C_ServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public XI_a3257215D786342Db8147628Fa0B492C_ServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for HTTP_Port
    private java.lang.String HTTP_Port_address = "http://srvgxp.goodee.cn:80/XISOAPAdapter/MessageServlet?senderParty=&senderService=BS_RF&receiverParty=&receiverService=&interface=SIO_SP&interfaceNamespace=urn%3Asp%3Adealup";
    ...
    public com.esb.jinying.sap.dealup.sp.SIO_SP getHTTP_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.esb.jinying.sap.dealup.sp.SIO_SPBindingStub _stub = new com.esb.jinying.sap.dealup.sp.SIO_SPBindingStub(portAddress, this);
    ...
    private java.lang.String HTTPS_Port_address = "https://srvgxp.goodee.cn/XISOAPAdapter/MessageServlet?senderParty=&senderService=BS_RF&receiverParty=&receiverService=&interface=SIO_SP&interfaceNamespace=urn%3Asp%3Adealup";
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.esb.jinying.sap.dealup.sp.SIO_SP.class.isAssignableFrom(serviceEndpointInterface)) {
                com.esb.jinying.sap.dealup.sp.SIO_SPBindingStub _stub = new com.esb.jinying.sap.dealup.sp.SIO_SPBindingStub(new java.net.URL(HTTP_Port_address), this);
                _stub.setPortName(getHTTP_PortWSDDServiceName());
                return _stub;
            }
            if (com.esb.jinying.sap.dealup.sp.SIO_SP.class.isAssignableFrom(serviceEndpointInterface)) {
                com.esb.jinying.sap.dealup.sp.SIO_SPBindingStub _stub = new com.esb.jinying.sap.dealup.sp.SIO_SPBindingStub(new java.net.URL(HTTPS_Port_address), this);
                _stub.setPortName(getHTTPS_PortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:sp:dealup", "XI_a3257215d786342db8147628fa0b492c_Service");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn:sp:dealup", "HTTP_Port"));
            ports.add(new javax.xml.namespace.QName("urn:sp:dealup", "HTTPS_Port"));
        }
