package com.httpproxy.common.constant;
...
public class StatusConstant {
	...
	public static String CODE_1204 = "1204";
	...
	public static String CODE_1201_MSG = "已接收";
	public static String CODE_1202_MSG = "已入队";
	public static String CODE_1203_MSG = "已请求";
	public static String CODE_1204_MSG = "已返回";
